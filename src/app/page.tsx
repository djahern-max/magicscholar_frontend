...
const AVAILABLE_STATES = [
  { code: 'AK', name: 'AK', fullName: 'Alaska', available: true, icon: '🏔️' },
  { code: 'AL', name: 'AL', fullName: 'Alabama', available: true, icon: '🏈' },
  { code: 'AR', name: 'AR', fullName: 'Arkansas', available: true, icon: '💎' },
  { code: 'AZ', name: 'AZ', fullName: 'Arizona', available: true, icon: '🌵' },
  { code: 'CA', name: 'CA', fullName: 'California', available: true, icon: '🌴' },
  { code: 'CO', name: 'CO', fullName: 'Colorado', available: true, icon: '⛰️' },
  { code: 'CT', name: 'CT', fullName: 'Connecticut', available: true, icon: '🌳' },
  { code: 'DC', name: 'DC', fullName: 'Washington DC', available: true, icon: '🏛️' },
  { code: 'DE', name: 'DE', fullName: 'Delaware', available: true, icon: '🦅' },
  { code: 'FL', name: 'FL', fullName: 'Florida', available: true, icon: '🌊' },
  { code: 'GA', name: 'GA', fullName: 'Georgia', available: true, icon: '🍑' },
  { code: 'HI', name: 'HI', fullName: 'Hawaii', available: true, icon: '🌺' },
  { code: 'IA', name: 'IA', fullName: 'Iowa', available: true, icon: '🌽' },
  { code: 'ID', name: 'ID', fullName: 'Idaho', available: true, icon: '🥔' },
  { code: 'IL', name: 'IL', fullName: 'Illinois', available: true, icon: '🌆' },
  { code: 'IN', name: 'IN', fullName: 'Indiana', available: true, icon: '🏎️' },
  { code: 'KS', name: 'KS', fullName: 'Kansas', available: true, icon: '🌾' },
  { code: 'KY', name: 'KY', fullName: 'Kentucky', available: true, icon: '🐴' },
  { code: 'LA', name: 'LA', fullName: 'Louisiana', available: true, icon: '🎷' },
  { code: 'MA', name: 'MA', fullName: 'Massachusetts', available: true, icon: '🎓' },
  { code: 'MD', name: 'MD', fullName: 'Maryland', available: true, icon: '🦀' },
  { code: 'ME', name: 'ME', fullName: 'Maine', available: true, icon: '🦞' },
  { code: 'MI', name: 'MI', fullName: 'Michigan', available: true, icon: '🚗' },
  { code: 'MN', name: 'MN', fullName: 'Minnesota', available: true, icon: '❄️' },
  { code: 'MO', name: 'MO', fullName: 'Missouri', available: true, icon: '🎸' },
  { code: 'MS', name: 'MS', fullName: 'Mississippi', available: true, icon: '🎵' },
  { code: 'MT', name: 'MT', fullName: 'Montana', available: true, icon: '🦌' },
  { code: 'NC', name: 'NC', fullName: 'North Carolina', available: true, icon: '🏀' },
  { code: 'ND', name: 'ND', fullName: 'North Dakota', available: true, icon: '🌾' },
  { code: 'NE', name: 'NE', fullName: 'Nebraska', available: true, icon: '🌽' },
  { code: 'NH', name: 'NH', fullName: 'New Hampshire', available: true, icon: '🏔️' },
  { code: 'NJ', name: 'NJ', fullName: 'New Jersey', available: true, icon: '🏖️' },
  { code: 'NM', name: 'NM', fullName: 'New Mexico', available: true, icon: '🌶️' },
  { code: 'NV', name: 'NV', fullName: 'Nevada', available: true, icon: '🎰' },
  { code: 'NY', name: 'NY', fullName: 'New York', available: true, icon: '🗽' },
  { code: 'OH', name: 'OH', fullName: 'Ohio', available: true, icon: '🌰' },
  { code: 'OK', name: 'OK', fullName: 'Oklahoma', available: true, icon: '🤠' },
  { code: 'OR', name: 'OR', fullName: 'Oregon', available: true, icon: '🌲' },
  { code: 'PA', name: 'PA', fullName: 'Pennsylvania', available: true, icon: '🔔' },
  { code: 'RI', name: 'RI', fullName: 'Rhode Island', available: true, icon: '⚓' },
  { code: 'SC', name: 'SC', fullName: 'South Carolina', available: true, icon: '🌴' },
  { code: 'SD', name: 'SD', fullName: 'South Dakota', available: true, icon: '🗻' },
  { code: 'TN', name: 'TN', fullName: 'Tennessee', available: true, icon: '🎸' },
  { code: 'TX', name: 'TX', fullName: 'Texas', available: true, icon: '⭐' },
  { code: 'UT', name: 'UT', fullName: 'Utah', available: true, icon: '🏔️' },
  { code: 'VA', name: 'VA', fullName: 'Virginia', available: true, icon: '🏛️' },
  { code: 'VT', name: 'VT', fullName: 'Vermont', available: true, icon: '🍁' },
  { code: 'WA', name: 'WA', fullName: 'Washington', available: true, icon: '🌲' },
  { code: 'WI', name: 'WI', fullName: 'Wisconsin', available: true, icon: '🧀' },
  { code: 'WV', name: 'WV', fullName: 'West Virginia', available: true, icon: '⛰️' },
  { code: 'WY', name: 'WY', fullName: 'Wyoming', available: true, icon: '🦬' }
];
